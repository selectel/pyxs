# -*- coding: utf-8 -*-
#
# pyxs documentation build configuration file, created by
...
project = u'pyxs'
copyright = u'2011-2012, Selectel'
...
latex_documents = [
  ('index', 'pyxs.tex', u'pyxs Documentation',
   u'Sergei Lebedev, Fedor Gogolev', 'manual'),
]
